...
//    Booking findByCheckOutDate(String checkOutDate);
    ...
    boolean existsByRoomAndStatus(Room room, BookingStatus bookingStatus);

    boolean existsByRoomAndStudentDetailsAndStatus(Room room, StudentDetails student, BookingStatus bookingStatus);
}